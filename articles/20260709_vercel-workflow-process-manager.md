...
この記事では、Vercel Workflowの書き方を交えつつ、なぜこの用途に合っていたのかをプロセスマネージャーパターンの観点で整理します。説明の都合上、イベント運営のフローを例に使います。

メモとして残していた内容もベースにしています。

https://zenn.dev/fukke/scraps/f3953ea4a10adb
...
<!-- TODO: プロセスマネージャーパターンの図解を入れる -->
![プロセスマネージャーパターン](PLACEHOLDER)
*プロセスマネージャーパターン*
